...
const MovieModal = ({ movie, closeModal }) => {
    ...
    return (
        <div className='flex items-center justify-center fixed z-50 w-full h-full bg-dark/80 top-0 left-0'>
            <div
                ref={modalWindow}
                className="relative z-50 modal bg-dark-900 overflow-hidden rounded-lg drop-shadow-2xl w-11/12 lg:w-8/12 2xl:w-6/12"
            >
                <button
                ...
                <div className='flex items-center'>
                    ...
                    <div className='w-2/3 p-8'>
                        <h4>
                            <a href={`https://imdb.com/title/${movie.imdbID}`} className='text-light hover:text-light-600'>
                                {movie.Title}
                            </a>
                        </h4>
